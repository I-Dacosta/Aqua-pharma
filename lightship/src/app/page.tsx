...
import { TeamSwitcher } from '@/components/marketing/TeamSwitcher';
import { ProductSection } from '@/components/marketing/ImageSectionPlaceholder';
import { WelcomeSection } from '@/components/marketing/WelcomeSection';
import { Navbar } from '@/components/marketing/Navbar';
import { ThemeProvider, ThemeMarker } from '@/components/marketing/ThemeController';
  ...
  return (
    <ThemeProvider>
      ...
      <main className="w-full flex flex-col items-center justify-start">
        ...
        {/* WelcomeSection (Rennsport replica) - light theme */}
        <ThemeMarker isDarkTheme={false} className="w-full">
          <WelcomeSection />
        </ThemeMarker>
