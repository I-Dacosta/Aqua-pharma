...
export function ProductSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full overflow-hidden bg-[#F4F4F6]"
      style={{ height: "100svh" }}
    >
      {/* ---------- Static header ---------- */}
      <div className="absolute top-10 left-0 right-0 z-20 pointer-events-none px-6 md:px-10 xl:px-14">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 max-w-[1600px] mx-auto">
          <div>
            <span className="block mb-5 text-[10px] font-bold tracking-[0.25em] text-[#151F6D]/50 uppercase">
              01 / Butikken
            </span>
            <h2 className="text-5xl md:text-7xl lg:text-[86px] font-thin tracking-tighter text-[#1a1d1d] leading-[0.88]">
              Industriell <br className="hidden md:block" /> Kvalitet
            </h2>
          </div>
          <div className="max-w-xs flex flex-col gap-5 pointer-events-auto">
            <p className="text-sm leading-relaxed text-[#1a1d1d]/55">
