            ...
            <div className="mx-auto flex w-full max-w-[100rem] flex-col gap-0">
                <div className="map-section map-section__map-shell relative overflow-hidden bg-white lg:min-h-[34rem] xl:min-h-[40rem]">
                    ...
                    <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-32 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(255,255,255,0)_100%)]" />
                        ...
                        {/* Left / Right side fades for map */}
                        <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-20 bg-[linear-gradient(90deg,rgba(255,255,255,0.96)_0%,rgba(255,255,255,0)_100%)] md:w-28 lg:w-36" />
                        <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-20 bg-[linear-gradient(270deg,rgba(255,255,255,0.96)_0%,rgba(255,255,255,0)_100%)] md:w-28 lg:w-36" />

                        <div className="pointer-events-none absolute left-6 top-3 z-50 md:left-8 md:top-4">
