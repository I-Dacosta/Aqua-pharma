        ...
        <div className="w-full">
          ...
          <div className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-3xl">
              ...
              <h2 className={`focus-header-element text-5xl md:text-7xl lg:text-[86px] font-thin tracking-tighter leading-[0.88] transition-colors duration-700 ${isDark ? 'text-white' : 'text-[#1a1d1d]'}`}>
                <TitleWithLogo
                  title="A Concept"
                  isDark={isDark}
              ...
              {areas.map((area, index) => {
                ...
                return (
                  <Link
                    ...
                    className={`
                      focus-content-item group flex items-center gap-4 cursor-pointer border-b
                      py-4 md:py-5 px-4 md:px-6 transition-all duration-500
                      ${isDark ? 'border-white/10 hover:bg-white/5' : 'border-[#1a1d1d]/10 hover:bg-[#1a1d1d]/5'}
                      ${isActive ? 'opacity-100' : 'opacity-60 hover:opacity-100'}
                    `}
                  >
                    <span className={`text-xs font-mono w-6 shrink-0 transition-colors duration-700 ${isDark ? 'text-white/50' : 'text-[#1a1d1d]/50'}`}>0{index + 1}</span>
                    <h3 className={`
                      text-base md:text-lg font-medium tracking-tight transition-transform duration-500
                    ...
                    {/* Arrow */}
                    <div className={`
                      ml-auto flex items-center justify-center transition-all duration-500
                      ${isActive
                        ? `${isDark ? 'text-white' : 'text-[#1a1d1d]'}`
                        : `${isDark ? 'text-white/40' : 'text-[#1a1d1d]/40'} group-hover:${isDark ? 'text-white/70' : 'text-[#1a1d1d]/70'}`}
                    `}>
                      <ArrowRight size={18} />
                    </div>
                  </Link>
